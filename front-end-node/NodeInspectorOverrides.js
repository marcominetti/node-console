...
WebInspector.NodeInspectorOverrides.prototype = {
  ...
  _mergeConnectionQueryParams: function(){
    if (Runtime._queryParamsObject['ws'] && Runtime._queryParamsObject['port']){
      if (Runtime._queryParamsObject['ws'].indexOf('?') === -1){
        Runtime._queryParamsObject['ws'] += '?';
      } else {
        Runtime._queryParamsObject['ws'] += '&';
      }
      Runtime._queryParamsObject['ws'] += 'port=' + Runtime._queryParamsObject['port'];
