...
(function() {
    ...
    this._esnext_transform = function(text){
			...
			try {
				...
				try {
				  ...
				  var esnext_suffix = '\n})();';
				  ast = babylon.parse(esnext_prefix + text + esnext_suffix, {
				    'allowImportExportEverywhere': false,
				    'allowReturnOutsideFunction': true,
				    'ecmaVersion': 7,
				    'playground': false,
			...
			var last_statement_container = ast.program.body[0].expression.callee.body;
			...
			var generated = babel.transform.fromAst(ast.program,null,{
				'stage': 2,
				'compact': false,
				'sourceMaps': false,
				'code': true,
    ...
    this.evaluate = function (params, sendResult) {
        ...
        try {
          ...
          result = eval.call(global, "with ({}) {\n" + this._esnext_transform(params.expression) + "\n}");
        } catch (e) {
